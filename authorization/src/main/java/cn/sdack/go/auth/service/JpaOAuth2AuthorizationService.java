...
public class JpaOAuth2AuthorizationService implements OAuth2AuthorizationService {
    private final AuthorizationDao authorizationRepository;
    private final JpaRegisteredClientRepository registeredClientRepository;
    private final ObjectMapper objectMapper = new ObjectMapper();

    public JpaOAuth2AuthorizationService(AuthorizationDao authorizationRepository, JpaRegisteredClientRepository registeredClientRepository) {
        ...
        this.objectMapper.addMixIn(AccountEntity.class, AccountMixin.class);
