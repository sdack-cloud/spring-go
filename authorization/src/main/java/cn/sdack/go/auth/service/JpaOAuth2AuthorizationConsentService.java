 ...
 * @date 2023/12/23
 */
import cn.sdack.go.auth.dao.AuthorizationConsentDao;
...
public class JpaOAuth2AuthorizationConsentService implements OAuth2AuthorizationConsentService {
    private final AuthorizationConsentDao authorizationConsentRepository;
    private final RegisteredClientRepository registeredClientRepository;

    public JpaOAuth2AuthorizationConsentService(AuthorizationConsentDao authorizationConsentRepository, RegisteredClientRepository registeredClientRepository) {
